...
export const hero = {
  ...
  ctaSecondary: { label: 'دانلود رزومه (PDF)', href: 'https://jobvision.ir/cv/69891430-185127' },
...
export const fragments = [
  { id: 'f1', group: 'idea', text: 'تو کدوم مدل بازیکنی؟', source: 'سناریو ریلز چهره واقعی پلیرها' },
  ...
  { id: 'f7', group: 'story', text: 'چیزی که گم شده بود فقط یک قطعه نبود؛ فهم مشترک بود.', source: 'پرونده قطعه گمشده، کادک' },
...
export const about = {
  ...
  story: [
    ...
    'برای من پیام یعنی تجربه. یک ویدیو، یک دفترچه قانون، یک صفحه کاتالوگ و یک بازی سازمانی، همه‌شون یک کار مشترک می‌کنن: آدم رو از نقطه «نمی‌دونم این چیه» می‌رسونن به نقطه «فهمیدم و می‌خوام امتحانش کنم».'
  ],
  skills: [
    'استراتژی محتوا',
    'مدیریت کمپین',
  ...
  steps: [
    {
      id: 'raw',
      title: 'ایده خام',
      text: 'هر چیزی که هست جمع می‌شه: حرف تیم، سؤال مخاطب، بازی روی میز، داده پنل.',
      example: 'برای ریلز «چی بازی کنیم؟» نقطه شروع یک جمله تکراری بین آدم‌ها بود: نیم ساعته داریم بازی انتخاب می‌کنیم.'
    },
    {
      id: 'research',
      title: 'تحقیق',
      text: 'قبل از نوشتن، منبع می‌خونم. قانون بازی، فایل مشتری، آمار کانال و کاری که قبلاً جواب داده.',
      example: 'برای مقاله‌های گیک‌بازی یک پروتکل تحقیق نوشتم تا هر مقاله قبل از نوشتن، منبع و نسخه درست بازی رو تأیید کنه.'
    },
    {
      id: 'strategy',
      title: 'استراتژی',
    ...
    },
    {
      ...
      example: 'پرونده قطعه گمشده برای کادک، در چند مرحله گروه‌ها رو به هم می‌رسونه تا اطلاعات ناقص کنار هم معنی پیدا کنه.'
    },
    {
      id: 'result',
      title: 'نتیجه',
      text: 'عدد و بازخورد رو نگاه می‌کنم و دفعه بعد را بر اساسش تصحیح می‌کنم.',
...
export const contact = {
  ...
  actions: [
    ...
    { label: 'دانلود رزومه (PDF)', href: 'https://jobvision.ir/cv/69891430-185127', primary: false }
  ],
  form: {
    endpoint: 'https://formspree.io/f/mljdeegg',
    title: 'بگویید دنبال چه چیزی هستید',
    lead: 'یک فرم کوتاه. نقش‌ها همان کارهایی‌ست که در همین صفحه دیدید، پس می‌دانم درباره چه چیزی حرف می‌زنیم.',
    roles: [
      'استراتژی و تقویم محتوا',
      'سناریو و کارگردانی ویدیو',
      'کپی‌رایتینگ و روایت برند',
      'UX رایتینگ و متن محصول',
      'بازی‌وارسازی و تجربه تعاملی',
...
export const aboutGame = {
  ...
  done: 'همه سوال‌ها رو پرسیدید. بقیه جواب‌ها توی پروژه‌های پایینه.',
  prompts: [
    {
    ...
    },
    {
      ...
      a: 'مرتبش می‌کنم. دفترچه قانون سنگین رو کوتاه نمی‌کنم؛ ترتیبش رو عوض می‌کنم تا بازیکن با هر صفحه یه قدم جلوتر بره.',
      source: 'شش دفترچه قانون فارسی، در بخش گیک‌بازی'
    },
    {
    ...
    {
      q: 'چرا بازی؟',
      a: 'چون بازی به مخاطب نقش می‌ده. آدمی که انتخاب می‌کنه و نتیجه انتخابش رو می‌بینه، پیام رو یادش می‌مونه.',
